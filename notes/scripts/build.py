...
def main():
    ...
    for post in get_posts():
        ...
        try:
            ...
            with open('docs/' + out_file, 'w') as f:
                f.write(TEMPLATE.format(post=output, meta="", tag=t, subtitle="", title="", tags="", frequent_tags="", full_url="https://notes.eatonphil.com/"+out_file))
            continue
    ...
    for (out_file, title, date, _, output, tags_html) in post_data:
        with open('docs/' + out_file, 'w') as f:
            f.write(TEMPLATE.format(post=output+showfeedback, title=title, subtitle=date, tag=title, tags=tags_html, meta="", frequent_tags=frequent_tags, full_url="https://notes.eatonphil.com/"+out_file))
    ...
    with open('docs/index.html', 'w') as f:
        ...
        f.write(TEMPLATE.format(post=home_page, title="", tag=TAG, subtitle="", tags="", meta=meta, frequent_tags="", full_url="https://notes.eatonphil.com"))
...
Sitemap: https://notes.eatonphil.com/sitemap.xml""")
    ...
    with open('docs/tags/index.html', 'w') as f:
        ...
        f.write(TEMPLATE.format(post=index_page, title="All Topics", tag="All Topics", subtitle="", tags="", meta="", frequent_tags="", full_url="https://notes.eatonphil.com/tags/"))
    ...
    for tag in all_tags:
        ...
        with open('docs/tags/'+file_name, 'w') as f:
            ...
            f.write(TEMPLATE.format(post=tag_page, title="", tag=TAG, subtitle="", tags="", meta="", frequent_tags="", full_url="https://notes.eatonphil.com/tags/"+file_name))
